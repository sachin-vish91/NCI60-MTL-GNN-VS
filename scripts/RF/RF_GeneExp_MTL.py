...
a = pd.read_excel('Profile_data/GeneExp/RNA__Affy_HG_U133_Plus_2.0_RMA.xls', skiprows=10, header=0, na_values='-')
...
for c in cells_in_gexp:
    ...
    with open('result_new/GeneExp/'+c+'.pred', 'w') as output:
